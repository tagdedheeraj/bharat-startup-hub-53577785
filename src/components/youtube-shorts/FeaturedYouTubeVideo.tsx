          ...
          {isPlaying ? (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="text-xl md:text-2xl font-bold text-white">Erkenci Kuş - Pehla Panchi</h3>
                <p className="text-white/80 mt-2">Click to play</p>
              </div>
            </div>
          )}
        </div>
