...
// Define the proper types for our icon components
...
const AIServiceCard = ({ 
  ...
  <Card className="bg-white/80 backdrop-blur-lg border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 group">
    ...
    <CardContent className="space-y-4">
      ...
      <Button className="w-full mt-4 group bg-brand-600 hover:bg-brand-700 text-white">
        Get Started
...
const AIServicesPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <SectionHeading
        heading="AI Services"
        subheading="Transforming Ideas into Intelligent Solutions"
